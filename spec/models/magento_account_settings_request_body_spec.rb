...
# Unit tests for ShipEngineApi::MagentoAccountSettingsRequestBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MagentoAccountSettingsRequestBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::MagentoAccountSettingsRequestBody.new
  end
  ...
  describe 'test an instance of MagentoAccountSettingsRequestBody' do
    it 'should create an instance of MagentoAccountSettingsRequestBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::MagentoAccountSettingsRequestBody)
    end
  end
  describe 'test attribute "automatically_import_sales_orders"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "unpaid_status"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "shipped_status"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "cancelled_status"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "hold_status"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "capture_payment"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
