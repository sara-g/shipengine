...
# Unit tests for ShipEngineApi::AddressValidationResult
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AddressValidationResult' do
  before do
    # run before each test
    @instance = ShipEngineApi::AddressValidationResult.new
  end
  ...
  describe 'test an instance of AddressValidationResult' do
    it 'should create an instance of AddressValidationResult' do
      expect(@instance).to be_instance_of(ShipEngineApi::AddressValidationResult)
    end
  end
