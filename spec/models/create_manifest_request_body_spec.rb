...
# Unit tests for ShipEngineApi::CreateManifestRequestBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateManifestRequestBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::CreateManifestRequestBody.new
  end
  ...
  describe 'test an instance of CreateManifestRequestBody' do
    it 'should create an instance of CreateManifestRequestBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::CreateManifestRequestBody)
    end
  end
