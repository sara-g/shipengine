...
# Unit tests for ShipEngineApi::RoyalMailAccountInformationRequestBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RoyalMailAccountInformationRequestBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::RoyalMailAccountInformationRequestBody.new
  end
  ...
  describe 'test an instance of RoyalMailAccountInformationRequestBody' do
    it 'should create an instance of RoyalMailAccountInformationRequestBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::RoyalMailAccountInformationRequestBody)
    end
  end
