...
# Unit tests for ShipEngineApi::ListManifestsRequestBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListManifestsRequestBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::ListManifestsRequestBody.new
  end
  ...
  describe 'test an instance of ListManifestsRequestBody' do
    it 'should create an instance of ListManifestsRequestBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::ListManifestsRequestBody)
    end
  end
  ...
  describe 'test attribute "ship_date_start"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "ship_date_end"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
