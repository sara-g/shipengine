...
# Unit tests for ShipEngineApi::ShipmentResponseError
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ShipmentResponseError' do
  before do
    # run before each test
    @instance = ShipEngineApi::ShipmentResponseError.new
  end
  ...
  describe 'test an instance of ShipmentResponseError' do
    it 'should create an instance of ShipmentResponseError' do
      expect(@instance).to be_instance_of(ShipEngineApi::ShipmentResponseError)
    end
  end
