...
# Unit tests for ShipEngineApi::NonDelivery
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NonDelivery' do
  before do
    # run before each test
    @instance = ShipEngineApi::NonDelivery.new
  end
  ...
  describe 'test an instance of NonDelivery' do
    it 'should create an instance of NonDelivery' do
      expect(@instance).to be_instance_of(ShipEngineApi::NonDelivery)
    end
  end
end
