...
# Unit tests for ShipEngineApi::DhlEcommerceAccountInformationRequestBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DhlEcommerceAccountInformationRequestBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::DhlEcommerceAccountInformationRequestBody.new
  end
  ...
  describe 'test an instance of DhlEcommerceAccountInformationRequestBody' do
    it 'should create an instance of DhlEcommerceAccountInformationRequestBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::DhlEcommerceAccountInformationRequestBody)
    end
  end
