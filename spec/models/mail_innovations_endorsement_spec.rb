...
# Unit tests for ShipEngineApi::MailInnovationsEndorsement
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MailInnovationsEndorsement' do
  before do
    # run before each test
    @instance = ShipEngineApi::MailInnovationsEndorsement.new
  end
  ...
  describe 'test an instance of MailInnovationsEndorsement' do
    it 'should create an instance of MailInnovationsEndorsement' do
      expect(@instance).to be_instance_of(ShipEngineApi::MailInnovationsEndorsement)
    end
  end
end
