...
# Unit tests for ShipEngineApi::FedexAccountInformationRequestBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FedexAccountInformationRequestBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::FedexAccountInformationRequestBody.new
  end
  ...
  describe 'test an instance of FedexAccountInformationRequestBody' do
    it 'should create an instance of FedexAccountInformationRequestBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::FedexAccountInformationRequestBody)
    end
  end
