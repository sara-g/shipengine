...
# Unit tests for ShipEngineApi::DhlExpressUkAccountInformationRequestBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DhlExpressUkAccountInformationRequestBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::DhlExpressUkAccountInformationRequestBody.new
  end
  ...
  describe 'test an instance of DhlExpressUkAccountInformationRequestBody' do
    it 'should create an instance of DhlExpressUkAccountInformationRequestBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::DhlExpressUkAccountInformationRequestBody)
    end
  end
