...
# Unit tests for ShipEngineApi::UpsInvoice
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpsInvoice' do
  before do
    # run before each test
    @instance = ShipEngineApi::UpsInvoice.new
  end
  ...
  describe 'test an instance of UpsInvoice' do
    it 'should create an instance of UpsInvoice' do
      expect(@instance).to be_instance_of(ShipEngineApi::UpsInvoice)
    end
  end
