...
# Unit tests for ShipEngineApi::AddressValidatingShipment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AddressValidatingShipment' do
  before do
    # run before each test
    @instance = ShipEngineApi::AddressValidatingShipment.new
  end
  ...
  describe 'test an instance of AddressValidatingShipment' do
    it 'should create an instance of AddressValidatingShipment' do
      expect(@instance).to be_instance_of(ShipEngineApi::AddressValidatingShipment)
    end
  end
