...
# Unit tests for ShipEngineApi::ManifestResponseBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ManifestResponseBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::ManifestResponseBody.new
  end
  ...
  describe 'test an instance of ManifestResponseBody' do
    it 'should create an instance of ManifestResponseBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::ManifestResponseBody)
    end
  end
