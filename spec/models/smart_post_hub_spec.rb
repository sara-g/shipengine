...
# Unit tests for ShipEngineApi::SmartPostHub
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SmartPostHub' do
  before do
    # run before each test
    @instance = ShipEngineApi::SmartPostHub.new
  end
  ...
  describe 'test an instance of SmartPostHub' do
    it 'should create an instance of SmartPostHub' do
      expect(@instance).to be_instance_of(ShipEngineApi::SmartPostHub)
    end
  end
end
