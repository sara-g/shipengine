...
# Unit tests for ShipEngineApi::ValidationStatus
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ValidationStatus' do
  before do
    # run before each test
    @instance = ShipEngineApi::ValidationStatus.new
  end
  ...
  describe 'test an instance of ValidationStatus' do
    it 'should create an instance of ValidationStatus' do
      expect(@instance).to be_instance_of(ShipEngineApi::ValidationStatus)
    end
  end
end
