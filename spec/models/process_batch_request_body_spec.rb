...
# Unit tests for ShipEngineApi::ProcessBatchRequestBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProcessBatchRequestBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::ProcessBatchRequestBody.new
  end
  ...
  describe 'test an instance of ProcessBatchRequestBody' do
    it 'should create an instance of ProcessBatchRequestBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::ProcessBatchRequestBody)
    end
  end
