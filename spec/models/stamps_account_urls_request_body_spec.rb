...
# Unit tests for ShipEngineApi::StampsAccountUrlsRequestBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'StampsAccountUrlsRequestBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::StampsAccountUrlsRequestBody.new
  end
  ...
  describe 'test an instance of StampsAccountUrlsRequestBody' do
    it 'should create an instance of StampsAccountUrlsRequestBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::StampsAccountUrlsRequestBody)
    end
  end
  describe 'test attribute "url_types"' do
    it 'should work' do
