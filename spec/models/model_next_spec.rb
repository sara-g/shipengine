...
# Unit tests for ShipEngineApi::ModelNext
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ModelNext' do
  before do
    # run before each test
    @instance = ShipEngineApi::ModelNext.new
  end
  ...
  describe 'test an instance of ModelNext' do
    it 'should create an instance of ModelNext' do
      expect(@instance).to be_instance_of(ShipEngineApi::ModelNext)
    end
  end
