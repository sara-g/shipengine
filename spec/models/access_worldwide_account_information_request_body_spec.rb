...
# Unit tests for ShipEngineApi::AccessWorldwideAccountInformationRequestBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AccessWorldwideAccountInformationRequestBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::AccessWorldwideAccountInformationRequestBody.new
  end
  ...
  describe 'test an instance of AccessWorldwideAccountInformationRequestBody' do
    it 'should create an instance of AccessWorldwideAccountInformationRequestBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::AccessWorldwideAccountInformationRequestBody)
    end
  end
