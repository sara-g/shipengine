...
# Unit tests for ShipEngineApi::OntracAccountInformationRequestBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OntracAccountInformationRequestBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::OntracAccountInformationRequestBody.new
  end
  ...
  describe 'test an instance of OntracAccountInformationRequestBody' do
    it 'should create an instance of OntracAccountInformationRequestBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::OntracAccountInformationRequestBody)
    end
  end
