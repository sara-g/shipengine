...
# Unit tests for ShipEngineApi::UpsAccountInformationRequestBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpsAccountInformationRequestBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::UpsAccountInformationRequestBody.new
  end
  ...
  describe 'test an instance of UpsAccountInformationRequestBody' do
    it 'should create an instance of UpsAccountInformationRequestBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::UpsAccountInformationRequestBody)
    end
  end
