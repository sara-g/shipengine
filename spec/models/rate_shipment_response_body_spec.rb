...
# Unit tests for ShipEngineApi::RateShipmentResponseBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RateShipmentResponseBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::RateShipmentResponseBody.new
  end
  ...
  describe 'test an instance of RateShipmentResponseBody' do
    it 'should create an instance of RateShipmentResponseBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::RateShipmentResponseBody)
    end
  end
  describe 'test attribute "rate_response"' do
    it 'should work' do
