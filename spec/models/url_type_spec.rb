...
# Unit tests for ShipEngineApi::UrlType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UrlType' do
  before do
    # run before each test
    @instance = ShipEngineApi::UrlType.new
  end
  ...
  describe 'test an instance of UrlType' do
    it 'should create an instance of UrlType' do
      expect(@instance).to be_instance_of(ShipEngineApi::UrlType)
    end
  end
end
