...
# Unit tests for ShipEngineApi::WarehouseRequestBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'WarehouseRequestBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::WarehouseRequestBody.new
  end
  ...
  describe 'test an instance of WarehouseRequestBody' do
    it 'should create an instance of WarehouseRequestBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::WarehouseRequestBody)
    end
  end
