...
# Unit tests for ShipEngineApi::BalanceResponseBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BalanceResponseBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::BalanceResponseBody.new
  end
  ...
  describe 'test an instance of BalanceResponseBody' do
    it 'should create an instance of BalanceResponseBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::BalanceResponseBody)
    end
  end
