...
# Unit tests for ShipEngineApi::LabelMessages
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LabelMessages' do
  before do
    # run before each test
    @instance = ShipEngineApi::LabelMessages.new
  end
  ...
  describe 'test an instance of LabelMessages' do
    it 'should create an instance of LabelMessages' do
      expect(@instance).to be_instance_of(ShipEngineApi::LabelMessages)
    end
  end
  ...
  describe 'test attribute "reference2"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "reference3"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
