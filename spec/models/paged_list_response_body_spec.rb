...
# Unit tests for ShipEngineApi::PagedListResponseBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PagedListResponseBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::PagedListResponseBody.new
  end
  ...
  describe 'test an instance of PagedListResponseBody' do
    it 'should create an instance of PagedListResponseBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::PagedListResponseBody)
    end
  end
