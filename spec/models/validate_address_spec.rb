...
# Unit tests for ShipEngineApi::ValidateAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ValidateAddress' do
  before do
    # run before each test
    @instance = ShipEngineApi::ValidateAddress.new
  end
  ...
  describe 'test an instance of ValidateAddress' do
    it 'should create an instance of ValidateAddress' do
      expect(@instance).to be_instance_of(ShipEngineApi::ValidateAddress)
    end
  end
end
