...
# Unit tests for ShipEngineApi::FedexAccountSettingsRequestBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FedexAccountSettingsRequestBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::FedexAccountSettingsRequestBody.new
  end
  ...
  describe 'test an instance of FedexAccountSettingsRequestBody' do
    it 'should create an instance of FedexAccountSettingsRequestBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::FedexAccountSettingsRequestBody)
    end
  end
