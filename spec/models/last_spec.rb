...
# Unit tests for ShipEngineApi::Last
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Last' do
  before do
    # run before each test
    @instance = ShipEngineApi::Last.new
  end
  ...
  describe 'test an instance of Last' do
    it 'should create an instance of Last' do
      expect(@instance).to be_instance_of(ShipEngineApi::Last)
    end
  end
