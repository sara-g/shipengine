...
# Unit tests for ShipEngineApi::AmazonAccountInformationRequestBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AmazonAccountInformationRequestBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::AmazonAccountInformationRequestBody.new
  end
  ...
  describe 'test an instance of AmazonAccountInformationRequestBody' do
    it 'should create an instance of AmazonAccountInformationRequestBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::AmazonAccountInformationRequestBody)
    end
  end
