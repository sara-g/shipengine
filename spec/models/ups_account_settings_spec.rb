...
# Unit tests for ShipEngineApi::UpsAccountSettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpsAccountSettings' do
  before do
    # run before each test
    @instance = ShipEngineApi::UpsAccountSettings.new
  end
  ...
  describe 'test an instance of UpsAccountSettings' do
    it 'should create an instance of UpsAccountSettings' do
      expect(@instance).to be_instance_of(ShipEngineApi::UpsAccountSettings)
    end
  end
