...
# Unit tests for ShipEngineApi::ListShipmentResponseBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListShipmentResponseBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::ListShipmentResponseBody.new
  end
  ...
  describe 'test an instance of ListShipmentResponseBody' do
    it 'should create an instance of ListShipmentResponseBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::ListShipmentResponseBody)
    end
  end
