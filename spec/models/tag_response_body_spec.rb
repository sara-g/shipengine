...
# Unit tests for ShipEngineApi::TagResponseBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TagResponseBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::TagResponseBody.new
  end
  ...
  describe 'test an instance of TagResponseBody' do
    it 'should create an instance of TagResponseBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::TagResponseBody)
    end
  end
