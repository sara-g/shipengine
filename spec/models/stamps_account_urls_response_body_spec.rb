...
# Unit tests for ShipEngineApi::StampsAccountUrlsResponseBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'StampsAccountUrlsResponseBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::StampsAccountUrlsResponseBody.new
  end
  ...
  describe 'test an instance of StampsAccountUrlsResponseBody' do
    it 'should create an instance of StampsAccountUrlsResponseBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::StampsAccountUrlsResponseBody)
    end
  end
