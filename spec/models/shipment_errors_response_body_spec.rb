...
# Unit tests for ShipEngineApi::ShipmentErrorsResponseBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ShipmentErrorsResponseBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::ShipmentErrorsResponseBody.new
  end
  ...
  describe 'test an instance of ShipmentErrorsResponseBody' do
    it 'should create an instance of ShipmentErrorsResponseBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::ShipmentErrorsResponseBody)
    end
  end
