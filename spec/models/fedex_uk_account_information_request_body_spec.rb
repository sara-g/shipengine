...
# Unit tests for ShipEngineApi::FedexUkAccountInformationRequestBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FedexUkAccountInformationRequestBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::FedexUkAccountInformationRequestBody.new
  end
  ...
  describe 'test an instance of FedexUkAccountInformationRequestBody' do
    it 'should create an instance of FedexUkAccountInformationRequestBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::FedexUkAccountInformationRequestBody)
    end
  end
