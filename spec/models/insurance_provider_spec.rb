...
# Unit tests for ShipEngineApi::InsuranceProvider
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InsuranceProvider' do
  before do
    # run before each test
    @instance = ShipEngineApi::InsuranceProvider.new
  end
  ...
  describe 'test an instance of InsuranceProvider' do
    it 'should create an instance of InsuranceProvider' do
      expect(@instance).to be_instance_of(ShipEngineApi::InsuranceProvider)
    end
  end
end
