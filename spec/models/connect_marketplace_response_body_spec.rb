...
# Unit tests for ShipEngineApi::ConnectMarketplaceResponseBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ConnectMarketplaceResponseBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::ConnectMarketplaceResponseBody.new
  end
  ...
  describe 'test an instance of ConnectMarketplaceResponseBody' do
    it 'should create an instance of ConnectMarketplaceResponseBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::ConnectMarketplaceResponseBody)
    end
  end
