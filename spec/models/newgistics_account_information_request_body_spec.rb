...
# Unit tests for ShipEngineApi::NewgisticsAccountInformationRequestBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NewgisticsAccountInformationRequestBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::NewgisticsAccountInformationRequestBody.new
  end
  ...
  describe 'test an instance of NewgisticsAccountInformationRequestBody' do
    it 'should create an instance of NewgisticsAccountInformationRequestBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::NewgisticsAccountInformationRequestBody)
    end
  end
