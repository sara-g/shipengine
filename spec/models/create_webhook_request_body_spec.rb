...
# Unit tests for ShipEngineApi::CreateWebhookRequestBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateWebhookRequestBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::CreateWebhookRequestBody.new
  end
  ...
  describe 'test an instance of CreateWebhookRequestBody' do
    it 'should create an instance of CreateWebhookRequestBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::CreateWebhookRequestBody)
    end
  end
