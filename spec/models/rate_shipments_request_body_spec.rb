...
# Unit tests for ShipEngineApi::RateShipmentsRequestBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RateShipmentsRequestBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::RateShipmentsRequestBody.new
  end
  ...
  describe 'test an instance of RateShipmentsRequestBody' do
    it 'should create an instance of RateShipmentsRequestBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::RateShipmentsRequestBody)
    end
  end
