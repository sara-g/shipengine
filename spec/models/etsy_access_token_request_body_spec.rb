...
# Unit tests for ShipEngineApi::EtsyAccessTokenRequestBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EtsyAccessTokenRequestBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::EtsyAccessTokenRequestBody.new
  end
  ...
  describe 'test an instance of EtsyAccessTokenRequestBody' do
    it 'should create an instance of EtsyAccessTokenRequestBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::EtsyAccessTokenRequestBody)
    end
  end
