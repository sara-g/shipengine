...
# Unit tests for ShipEngineApi::NewgisticsAccountSettingsRequestBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NewgisticsAccountSettingsRequestBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::NewgisticsAccountSettingsRequestBody.new
  end
  ...
  describe 'test an instance of NewgisticsAccountSettingsRequestBody' do
    it 'should create an instance of NewgisticsAccountSettingsRequestBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::NewgisticsAccountSettingsRequestBody)
    end
  end
