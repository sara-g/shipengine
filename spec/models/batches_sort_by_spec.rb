...
# Unit tests for ShipEngineApi::BatchesSortBy
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BatchesSortBy' do
  before do
    # run before each test
    @instance = ShipEngineApi::BatchesSortBy.new
  end
  ...
  describe 'test an instance of BatchesSortBy' do
    it 'should create an instance of BatchesSortBy' do
      expect(@instance).to be_instance_of(ShipEngineApi::BatchesSortBy)
    end
  end
end
