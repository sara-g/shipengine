...
# Unit tests for ShipEngineApi::FirstMileAccountInformationRequestBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FirstMileAccountInformationRequestBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::FirstMileAccountInformationRequestBody.new
  end
  ...
  describe 'test an instance of FirstMileAccountInformationRequestBody' do
    it 'should create an instance of FirstMileAccountInformationRequestBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::FirstMileAccountInformationRequestBody)
    end
  end
