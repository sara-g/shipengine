...
# Unit tests for ShipEngineApi::ShipmentAddTagResponseBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ShipmentAddTagResponseBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::ShipmentAddTagResponseBody.new
  end
  ...
  describe 'test an instance of ShipmentAddTagResponseBody' do
    it 'should create an instance of ShipmentAddTagResponseBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::ShipmentAddTagResponseBody)
    end
  end
