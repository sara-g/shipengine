...
# Unit tests for ShipEngineApi::EbayAccessTokenRequestBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EbayAccessTokenRequestBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::EbayAccessTokenRequestBody.new
  end
  ...
  describe 'test an instance of EbayAccessTokenRequestBody' do
    it 'should create an instance of EbayAccessTokenRequestBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::EbayAccessTokenRequestBody)
    end
  end
