...
# Unit tests for ShipEngineApi::BillToParty
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BillToParty' do
  before do
    # run before each test
    @instance = ShipEngineApi::BillToParty.new
  end
  ...
  describe 'test an instance of BillToParty' do
    it 'should create an instance of BillToParty' do
      expect(@instance).to be_instance_of(ShipEngineApi::BillToParty)
    end
  end
end
