...
# Unit tests for ShipEngineApi::StampsAccountUrlResponseBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'StampsAccountUrlResponseBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::StampsAccountUrlResponseBody.new
  end
  ...
  describe 'test an instance of StampsAccountUrlResponseBody' do
    it 'should create an instance of StampsAccountUrlResponseBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::StampsAccountUrlResponseBody)
    end
  end
