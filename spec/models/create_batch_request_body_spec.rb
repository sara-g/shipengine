...
# Unit tests for ShipEngineApi::CreateBatchRequestBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateBatchRequestBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::CreateBatchRequestBody.new
  end
  ...
  describe 'test an instance of CreateBatchRequestBody' do
    it 'should create an instance of CreateBatchRequestBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::CreateBatchRequestBody)
    end
  end
