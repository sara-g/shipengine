...
# Unit tests for ShipEngineApi::PaginationLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PaginationLink' do
  before do
    # run before each test
    @instance = ShipEngineApi::PaginationLink.new
  end
  ...
  describe 'test an instance of PaginationLink' do
    it 'should create an instance of PaginationLink' do
      expect(@instance).to be_instance_of(ShipEngineApi::PaginationLink)
    end
  end
