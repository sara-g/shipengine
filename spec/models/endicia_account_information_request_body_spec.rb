...
# Unit tests for ShipEngineApi::EndiciaAccountInformationRequestBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EndiciaAccountInformationRequestBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::EndiciaAccountInformationRequestBody.new
  end
  ...
  describe 'test an instance of EndiciaAccountInformationRequestBody' do
    it 'should create an instance of EndiciaAccountInformationRequestBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::EndiciaAccountInformationRequestBody)
    end
  end
