...
# Unit tests for ShipEngineApi::ModifyBatchRequestBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ModifyBatchRequestBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::ModifyBatchRequestBody.new
  end
  ...
  describe 'test an instance of ModifyBatchRequestBody' do
    it 'should create an instance of ModifyBatchRequestBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::ModifyBatchRequestBody)
    end
  end
