...
# Unit tests for ShipEngineApi::LabelLayout
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LabelLayout' do
  before do
    # run before each test
    @instance = ShipEngineApi::LabelLayout.new
  end
  ...
  describe 'test an instance of LabelLayout' do
    it 'should create an instance of LabelLayout' do
      expect(@instance).to be_instance_of(ShipEngineApi::LabelLayout)
    end
  end
end
