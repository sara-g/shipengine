...
# Unit tests for ShipEngineApi::CreateShipmentsResponseBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateShipmentsResponseBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::CreateShipmentsResponseBody.new
  end
  ...
  describe 'test an instance of CreateShipmentsResponseBody' do
    it 'should create an instance of CreateShipmentsResponseBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::CreateShipmentsResponseBody)
    end
  end
