...
# Unit tests for ShipEngineApi::StampsAccountInformationRequestBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'StampsAccountInformationRequestBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::StampsAccountInformationRequestBody.new
  end
  ...
  describe 'test an instance of StampsAccountInformationRequestBody' do
    it 'should create an instance of StampsAccountInformationRequestBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::StampsAccountInformationRequestBody)
    end
  end
