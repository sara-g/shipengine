...
# Unit tests for ShipEngineApi::MagentoAccountInformationRequestBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MagentoAccountInformationRequestBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::MagentoAccountInformationRequestBody.new
  end
  ...
  describe 'test an instance of MagentoAccountInformationRequestBody' do
    it 'should create an instance of MagentoAccountInformationRequestBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::MagentoAccountInformationRequestBody)
    end
  end
