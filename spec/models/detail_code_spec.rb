...
# Unit tests for ShipEngineApi::DetailCode
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DetailCode' do
  before do
    # run before each test
    @instance = ShipEngineApi::DetailCode.new
  end
  ...
  describe 'test an instance of DetailCode' do
    it 'should create an instance of DetailCode' do
      expect(@instance).to be_instance_of(ShipEngineApi::DetailCode)
    end
  end
end
