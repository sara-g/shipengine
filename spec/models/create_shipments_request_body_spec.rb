...
# Unit tests for ShipEngineApi::CreateShipmentsRequestBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateShipmentsRequestBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::CreateShipmentsRequestBody.new
  end
  ...
  describe 'test an instance of CreateShipmentsRequestBody' do
    it 'should create an instance of CreateShipmentsRequestBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::CreateShipmentsRequestBody)
    end
  end
