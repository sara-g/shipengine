...
# Unit tests for ShipEngineApi::RateResponseStatus
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RateResponseStatus' do
  before do
    # run before each test
    @instance = ShipEngineApi::RateResponseStatus.new
  end
  ...
  describe 'test an instance of RateResponseStatus' do
    it 'should create an instance of RateResponseStatus' do
      expect(@instance).to be_instance_of(ShipEngineApi::RateResponseStatus)
    end
  end
end
