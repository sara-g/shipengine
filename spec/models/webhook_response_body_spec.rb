...
# Unit tests for ShipEngineApi::WebhookResponseBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'WebhookResponseBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::WebhookResponseBody.new
  end
  ...
  describe 'test an instance of WebhookResponseBody' do
    it 'should create an instance of WebhookResponseBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::WebhookResponseBody)
    end
  end
