...
# Unit tests for ShipEngineApi::PurchaseLabelRequestBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PurchaseLabelRequestBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::PurchaseLabelRequestBody.new
  end
  ...
  describe 'test an instance of PurchaseLabelRequestBody' do
    it 'should create an instance of PurchaseLabelRequestBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::PurchaseLabelRequestBody)
    end
  end
