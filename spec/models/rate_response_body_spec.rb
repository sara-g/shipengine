...
# Unit tests for ShipEngineApi::RateResponseBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RateResponseBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::RateResponseBody.new
  end
  ...
  describe 'test an instance of RateResponseBody' do
    it 'should create an instance of RateResponseBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::RateResponseBody)
    end
  end
