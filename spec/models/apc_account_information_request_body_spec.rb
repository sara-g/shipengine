...
# Unit tests for ShipEngineApi::ApcAccountInformationRequestBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ApcAccountInformationRequestBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::ApcAccountInformationRequestBody.new
  end
  ...
  describe 'test an instance of ApcAccountInformationRequestBody' do
    it 'should create an instance of ApcAccountInformationRequestBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::ApcAccountInformationRequestBody)
    end
  end
