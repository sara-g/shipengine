...
# Unit tests for ShipEngineApi::TrackingInformationResponseBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TrackingInformationResponseBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::TrackingInformationResponseBody.new
  end
  ...
  describe 'test an instance of TrackingInformationResponseBody' do
    it 'should create an instance of TrackingInformationResponseBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::TrackingInformationResponseBody)
    end
  end
  ...
  describe 'test attribute "carrier_status_code"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "carrier_status_description"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "exception_description"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
