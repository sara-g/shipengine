...
# Unit tests for ShipEngineApi::RrDonnelleyAccountInformationRequestBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RrDonnelleyAccountInformationRequestBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::RrDonnelleyAccountInformationRequestBody.new
  end
  ...
  describe 'test an instance of RrDonnelleyAccountInformationRequestBody' do
    it 'should create an instance of RrDonnelleyAccountInformationRequestBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::RrDonnelleyAccountInformationRequestBody)
    end
  end
