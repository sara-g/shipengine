...
# Unit tests for ShipEngineApi::ListManifestsResponseBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListManifestsResponseBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::ListManifestsResponseBody.new
  end
  ...
  describe 'test an instance of ListManifestsResponseBody' do
    it 'should create an instance of ListManifestsResponseBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::ListManifestsResponseBody)
    end
  end
