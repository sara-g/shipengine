...
# Unit tests for ShipEngineApi::UpsPickupType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpsPickupType' do
  before do
    # run before each test
    @instance = ShipEngineApi::UpsPickupType.new
  end
  ...
  describe 'test an instance of UpsPickupType' do
    it 'should create an instance of UpsPickupType' do
      expect(@instance).to be_instance_of(ShipEngineApi::UpsPickupType)
    end
  end
end
