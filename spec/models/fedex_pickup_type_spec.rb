...
# Unit tests for ShipEngineApi::FedexPickupType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FedexPickupType' do
  before do
    # run before each test
    @instance = ShipEngineApi::FedexPickupType.new
  end
  ...
  describe 'test an instance of FedexPickupType' do
    it 'should create an instance of FedexPickupType' do
      expect(@instance).to be_instance_of(ShipEngineApi::FedexPickupType)
    end
  end
end
