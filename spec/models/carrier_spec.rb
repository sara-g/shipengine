...
# Unit tests for ShipEngineApi::Carrier
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Carrier' do
  before do
    # run before each test
    @instance = ShipEngineApi::Carrier.new
  end
  ...
  describe 'test an instance of Carrier' do
    it 'should create an instance of Carrier' do
      expect(@instance).to be_instance_of(ShipEngineApi::Carrier)
    end
  end
  ...
  describe 'test attribute "has_multi_package_supporting_services"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "supports_label_messages"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
