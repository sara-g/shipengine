...
# Unit tests for ShipEngineApi::ListTagResponseBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListTagResponseBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::ListTagResponseBody.new
  end
  ...
  describe 'test an instance of ListTagResponseBody' do
    it 'should create an instance of ListTagResponseBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::ListTagResponseBody)
    end
  end
