...
# Unit tests for ShipEngineApi::First
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'First' do
  before do
    # run before each test
    @instance = ShipEngineApi::First.new
  end
  ...
  describe 'test an instance of First' do
    it 'should create an instance of First' do
      expect(@instance).to be_instance_of(ShipEngineApi::First)
    end
  end
