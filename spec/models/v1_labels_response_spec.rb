...
# Unit tests for ShipEngineApi::V1LabelsResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'V1LabelsResponse' do
  before do
    # run before each test
    @instance = ShipEngineApi::V1LabelsResponse.new
  end
  ...
  describe 'test an instance of V1LabelsResponse' do
    it 'should create an instance of V1LabelsResponse' do
      expect(@instance).to be_instance_of(ShipEngineApi::V1LabelsResponse)
    end
  end
