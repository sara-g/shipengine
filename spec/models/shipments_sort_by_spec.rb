...
# Unit tests for ShipEngineApi::ShipmentsSortBy
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ShipmentsSortBy' do
  before do
    # run before each test
    @instance = ShipEngineApi::ShipmentsSortBy.new
  end
  ...
  describe 'test an instance of ShipmentsSortBy' do
    it 'should create an instance of ShipmentsSortBy' do
      expect(@instance).to be_instance_of(ShipEngineApi::ShipmentsSortBy)
    end
  end
end
