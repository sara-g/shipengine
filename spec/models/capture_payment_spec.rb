...
# Unit tests for ShipEngineApi::CapturePayment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CapturePayment' do
  before do
    # run before each test
    @instance = ShipEngineApi::CapturePayment.new
  end
  ...
  describe 'test an instance of CapturePayment' do
    it 'should create an instance of CapturePayment' do
      expect(@instance).to be_instance_of(ShipEngineApi::CapturePayment)
    end
  end
end
