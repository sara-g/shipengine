...
# Unit tests for ShipEngineApi::DhlExpressAccountSettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DhlExpressAccountSettings' do
  before do
    # run before each test
    @instance = ShipEngineApi::DhlExpressAccountSettings.new
  end
  ...
  describe 'test an instance of DhlExpressAccountSettings' do
    it 'should create an instance of DhlExpressAccountSettings' do
      expect(@instance).to be_instance_of(ShipEngineApi::DhlExpressAccountSettings)
    end
  end
