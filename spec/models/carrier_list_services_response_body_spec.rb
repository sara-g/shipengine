...
# Unit tests for ShipEngineApi::CarrierListServicesResponseBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CarrierListServicesResponseBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::CarrierListServicesResponseBody.new
  end
  ...
  describe 'test an instance of CarrierListServicesResponseBody' do
    it 'should create an instance of CarrierListServicesResponseBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::CarrierListServicesResponseBody)
    end
  end
