...
# Unit tests for ShipEngineApi::CarrierAdvancedOption
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CarrierAdvancedOption' do
  before do
    # run before each test
    @instance = ShipEngineApi::CarrierAdvancedOption.new
  end
  ...
  describe 'test an instance of CarrierAdvancedOption' do
    it 'should create an instance of CarrierAdvancedOption' do
      expect(@instance).to be_instance_of(ShipEngineApi::CarrierAdvancedOption)
    end
  end
