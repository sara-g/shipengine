...
# Unit tests for ShipEngineApi::DhlExpressAccountInformationRequestBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DhlExpressAccountInformationRequestBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::DhlExpressAccountInformationRequestBody.new
  end
  ...
  describe 'test an instance of DhlExpressAccountInformationRequestBody' do
    it 'should create an instance of DhlExpressAccountInformationRequestBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::DhlExpressAccountInformationRequestBody)
    end
  end
