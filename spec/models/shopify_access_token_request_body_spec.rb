...
# Unit tests for ShipEngineApi::ShopifyAccessTokenRequestBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ShopifyAccessTokenRequestBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::ShopifyAccessTokenRequestBody.new
  end
  ...
  describe 'test an instance of ShopifyAccessTokenRequestBody' do
    it 'should create an instance of ShopifyAccessTokenRequestBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::ShopifyAccessTokenRequestBody)
    end
  end
  ...
  describe 'test attribute "private_application_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
