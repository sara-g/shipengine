...
# Unit tests for ShipEngineApi::ProviderError
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProviderError' do
  before do
    # run before each test
    @instance = ShipEngineApi::ProviderError.new
  end
  ...
  describe 'test an instance of ProviderError' do
    it 'should create an instance of ProviderError' do
      expect(@instance).to be_instance_of(ShipEngineApi::ProviderError)
    end
  end
