...
# Unit tests for ShipEngineApi::ImexAccountInformationRequestBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ImexAccountInformationRequestBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::ImexAccountInformationRequestBody.new
  end
  ...
  describe 'test an instance of ImexAccountInformationRequestBody' do
    it 'should create an instance of ImexAccountInformationRequestBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::ImexAccountInformationRequestBody)
    end
  end
