...
# Unit tests for ShipEngineApi::ListBatchResponseBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListBatchResponseBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::ListBatchResponseBody.new
  end
  ...
  describe 'test an instance of ListBatchResponseBody' do
    it 'should create an instance of ListBatchResponseBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::ListBatchResponseBody)
    end
  end
