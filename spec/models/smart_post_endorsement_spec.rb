...
# Unit tests for ShipEngineApi::SmartPostEndorsement
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SmartPostEndorsement' do
  before do
    # run before each test
    @instance = ShipEngineApi::SmartPostEndorsement.new
  end
  ...
  describe 'test an instance of SmartPostEndorsement' do
    it 'should create an instance of SmartPostEndorsement' do
      expect(@instance).to be_instance_of(ShipEngineApi::SmartPostEndorsement)
    end
  end
end
