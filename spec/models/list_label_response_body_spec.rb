...
# Unit tests for ShipEngineApi::ListLabelResponseBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListLabelResponseBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::ListLabelResponseBody.new
  end
  ...
  describe 'test an instance of ListLabelResponseBody' do
    it 'should create an instance of ListLabelResponseBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::ListLabelResponseBody)
    end
  end
