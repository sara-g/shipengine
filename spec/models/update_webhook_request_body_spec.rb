...
# Unit tests for ShipEngineApi::UpdateWebhookRequestBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdateWebhookRequestBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::UpdateWebhookRequestBody.new
  end
  ...
  describe 'test an instance of UpdateWebhookRequestBody' do
    it 'should create an instance of UpdateWebhookRequestBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::UpdateWebhookRequestBody)
    end
  end
