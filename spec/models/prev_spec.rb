...
# Unit tests for ShipEngineApi::Prev
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Prev' do
  before do
    # run before each test
    @instance = ShipEngineApi::Prev.new
  end
  ...
  describe 'test an instance of Prev' do
    it 'should create an instance of Prev' do
      expect(@instance).to be_instance_of(ShipEngineApi::Prev)
    end
  end
