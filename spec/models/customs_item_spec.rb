...
# Unit tests for ShipEngineApi::CustomsItem
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CustomsItem' do
  before do
    # run before each test
    @instance = ShipEngineApi::CustomsItem.new
  end
  ...
  describe 'test an instance of CustomsItem' do
    it 'should create an instance of CustomsItem' do
      expect(@instance).to be_instance_of(ShipEngineApi::CustomsItem)
    end
  end
  describe 'test attribute "customs_item_id"' do
    it 'should work' do
  ...
  describe 'test attribute "harmonized_tariff_code"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
