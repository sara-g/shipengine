...
# Unit tests for ShipEngineApi::ErrorResponseBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ErrorResponseBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::ErrorResponseBody.new
  end
  ...
  describe 'test an instance of ErrorResponseBody' do
    it 'should create an instance of ErrorResponseBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::ErrorResponseBody)
    end
  end
