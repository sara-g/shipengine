...
# Unit tests for ShipEngineApi::BulkRateResponseBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BulkRateResponseBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::BulkRateResponseBody.new
  end
  ...
  describe 'test an instance of BulkRateResponseBody' do
    it 'should create an instance of BulkRateResponseBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::BulkRateResponseBody)
    end
  end
