...
# Unit tests for ShipEngineApi::BatchErrorsResponseBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BatchErrorsResponseBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::BatchErrorsResponseBody.new
  end
  ...
  describe 'test an instance of BatchErrorsResponseBody' do
    it 'should create an instance of BatchErrorsResponseBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::BatchErrorsResponseBody)
    end
  end
