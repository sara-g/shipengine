...
# Unit tests for ShipEngineApi::WarehouseListResponseBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'WarehouseListResponseBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::WarehouseListResponseBody.new
  end
  ...
  describe 'test an instance of WarehouseListResponseBody' do
    it 'should create an instance of WarehouseListResponseBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::WarehouseListResponseBody)
    end
  end
