...
# Unit tests for ShipEngineApi::VoidLabelResponseBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VoidLabelResponseBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::VoidLabelResponseBody.new
  end
  ...
  describe 'test an instance of VoidLabelResponseBody' do
    it 'should create an instance of VoidLabelResponseBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::VoidLabelResponseBody)
    end
  end
