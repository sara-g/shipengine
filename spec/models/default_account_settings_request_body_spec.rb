...
# Unit tests for ShipEngineApi::DefaultAccountSettingsRequestBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DefaultAccountSettingsRequestBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::DefaultAccountSettingsRequestBody.new
  end
  ...
  describe 'test an instance of DefaultAccountSettingsRequestBody' do
    it 'should create an instance of DefaultAccountSettingsRequestBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::DefaultAccountSettingsRequestBody)
    end
  end
