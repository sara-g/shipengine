...
# Unit tests for ShipEngineApi::CarrierListOptionsResponseBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CarrierListOptionsResponseBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::CarrierListOptionsResponseBody.new
  end
  ...
  describe 'test an instance of CarrierListOptionsResponseBody' do
    it 'should create an instance of CarrierListOptionsResponseBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::CarrierListOptionsResponseBody)
    end
  end
