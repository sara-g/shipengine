...
# Unit tests for ShipEngineApi::RateShipmentRequestBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RateShipmentRequestBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::RateShipmentRequestBody.new
  end
  ...
  describe 'test an instance of RateShipmentRequestBody' do
    it 'should create an instance of RateShipmentRequestBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::RateShipmentRequestBody)
    end
  end
