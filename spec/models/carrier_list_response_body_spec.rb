...
# Unit tests for ShipEngineApi::CarrierListResponseBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CarrierListResponseBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::CarrierListResponseBody.new
  end
  ...
  describe 'test an instance of CarrierListResponseBody' do
    it 'should create an instance of CarrierListResponseBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::CarrierListResponseBody)
    end
  end
