...
# Unit tests for ShipEngineApi::GlobegisticsAccountInformationRequestBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GlobegisticsAccountInformationRequestBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::GlobegisticsAccountInformationRequestBody.new
  end
  ...
  describe 'test an instance of GlobegisticsAccountInformationRequestBody' do
    it 'should create an instance of GlobegisticsAccountInformationRequestBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::GlobegisticsAccountInformationRequestBody)
    end
  end
