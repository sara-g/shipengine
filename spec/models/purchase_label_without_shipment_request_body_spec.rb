...
# Unit tests for ShipEngineApi::PurchaseLabelWithoutShipmentRequestBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PurchaseLabelWithoutShipmentRequestBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::PurchaseLabelWithoutShipmentRequestBody.new
  end
  ...
  describe 'test an instance of PurchaseLabelWithoutShipmentRequestBody' do
    it 'should create an instance of PurchaseLabelWithoutShipmentRequestBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::PurchaseLabelWithoutShipmentRequestBody)
    end
  end
