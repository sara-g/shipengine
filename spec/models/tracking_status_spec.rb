...
# Unit tests for ShipEngineApi::TrackingStatus
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TrackingStatus' do
  before do
    # run before each test
    @instance = ShipEngineApi::TrackingStatus.new
  end
  ...
  describe 'test an instance of TrackingStatus' do
    it 'should create an instance of TrackingStatus' do
      expect(@instance).to be_instance_of(ShipEngineApi::TrackingStatus)
    end
  end
end
