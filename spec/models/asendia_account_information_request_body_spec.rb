...
# Unit tests for ShipEngineApi::AsendiaAccountInformationRequestBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AsendiaAccountInformationRequestBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::AsendiaAccountInformationRequestBody.new
  end
  ...
  describe 'test an instance of AsendiaAccountInformationRequestBody' do
    it 'should create an instance of AsendiaAccountInformationRequestBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::AsendiaAccountInformationRequestBody)
    end
  end
