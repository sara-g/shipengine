...
# Unit tests for ShipEngineApi::DimensionUnit
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DimensionUnit' do
  before do
    # run before each test
    @instance = ShipEngineApi::DimensionUnit.new
  end
  ...
  describe 'test an instance of DimensionUnit' do
    it 'should create an instance of DimensionUnit' do
      expect(@instance).to be_instance_of(ShipEngineApi::DimensionUnit)
    end
  end
end
