...
# Unit tests for ShipEngineApi::ConnectAccountResponseBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ConnectAccountResponseBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::ConnectAccountResponseBody.new
  end
  ...
  describe 'test an instance of ConnectAccountResponseBody' do
    it 'should create an instance of ConnectAccountResponseBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::ConnectAccountResponseBody)
    end
  end
