...
# Unit tests for ShipEngineApi::RateRequestBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RateRequestBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::RateRequestBody.new
  end
  ...
  describe 'test an instance of RateRequestBody' do
    it 'should create an instance of RateRequestBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::RateRequestBody)
    end
  end
