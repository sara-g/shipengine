...
# Unit tests for ShipEngineApi::BatchResponseError
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BatchResponseError' do
  before do
    # run before each test
    @instance = ShipEngineApi::BatchResponseError.new
  end
  ...
  describe 'test an instance of BatchResponseError' do
    it 'should create an instance of BatchResponseError' do
      expect(@instance).to be_instance_of(ShipEngineApi::BatchResponseError)
    end
  end
