...
# Unit tests for ShipEngineApi::PackageListResponseBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PackageListResponseBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::PackageListResponseBody.new
  end
  ...
  describe 'test an instance of PackageListResponseBody' do
    it 'should create an instance of PackageListResponseBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::PackageListResponseBody)
    end
  end
