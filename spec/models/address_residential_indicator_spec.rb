...
# Unit tests for ShipEngineApi::AddressResidentialIndicator
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AddressResidentialIndicator' do
  before do
    # run before each test
    @instance = ShipEngineApi::AddressResidentialIndicator.new
  end
  ...
  describe 'test an instance of AddressResidentialIndicator' do
    it 'should create an instance of AddressResidentialIndicator' do
      expect(@instance).to be_instance_of(ShipEngineApi::AddressResidentialIndicator)
    end
  end
end
