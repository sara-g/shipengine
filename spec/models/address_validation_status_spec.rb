...
# Unit tests for ShipEngineApi::AddressValidationStatus
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AddressValidationStatus' do
  before do
    # run before each test
    @instance = ShipEngineApi::AddressValidationStatus.new
  end
  ...
  describe 'test an instance of AddressValidationStatus' do
    it 'should create an instance of AddressValidationStatus' do
      expect(@instance).to be_instance_of(ShipEngineApi::AddressValidationStatus)
    end
  end
end
