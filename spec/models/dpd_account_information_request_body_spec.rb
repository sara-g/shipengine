...
# Unit tests for ShipEngineApi::DpdAccountInformationRequestBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DpdAccountInformationRequestBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::DpdAccountInformationRequestBody.new
  end
  ...
  describe 'test an instance of DpdAccountInformationRequestBody' do
    it 'should create an instance of DpdAccountInformationRequestBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::DpdAccountInformationRequestBody)
    end
  end
