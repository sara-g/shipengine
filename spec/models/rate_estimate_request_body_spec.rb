...
# Unit tests for ShipEngineApi::RateEstimateRequestBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RateEstimateRequestBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::RateEstimateRequestBody.new
  end
  ...
  describe 'test an instance of RateEstimateRequestBody' do
    it 'should create an instance of RateEstimateRequestBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::RateEstimateRequestBody)
    end
  end
