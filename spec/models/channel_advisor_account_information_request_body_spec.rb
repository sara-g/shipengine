...
# Unit tests for ShipEngineApi::ChannelAdvisorAccountInformationRequestBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChannelAdvisorAccountInformationRequestBody' do
  before do
    # run before each test
    @instance = ShipEngineApi::ChannelAdvisorAccountInformationRequestBody.new
  end
  ...
  describe 'test an instance of ChannelAdvisorAccountInformationRequestBody' do
    it 'should create an instance of ChannelAdvisorAccountInformationRequestBody' do
      expect(@instance).to be_instance_of(ShipEngineApi::ChannelAdvisorAccountInformationRequestBody)
    end
  end
