...
# Unit tests for ShipEngineApi::AmazonProductIdentifier
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AmazonProductIdentifier' do
  before do
    # run before each test
    @instance = ShipEngineApi::AmazonProductIdentifier.new
  end
  ...
  describe 'test an instance of AmazonProductIdentifier' do
    it 'should create an instance of AmazonProductIdentifier' do
      expect(@instance).to be_instance_of(ShipEngineApi::AmazonProductIdentifier)
    end
  end
end
