...
describe 'RatesApi' do
  ...
  # unit tests for v1_rates_bulk_post
  # rates.bulk_rate_shipments
  # 
  # @param body 
  # @param [Hash] opts the optional parameters
  # @return [Array<BulkRateResponseBody>]
  describe 'v1_rates_bulk_post test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for v1_rates_by_rate_id_get
  # rates.get_by_id
  # 
  # @param rate_id 
  # @param [Hash] opts the optional parameters
  # @return [Rate]
  describe 'v1_rates_by_rate_id_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for v1_rates_estimate_post
  # rates.estimate
  # 
  # @param body 
  # @param [Hash] opts the optional parameters
  # @return [Array<Rate>]
  describe 'v1_rates_estimate_post test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for v1_rates_post
  # rates.rate_shipment
  # 
  # @param body 
  # @param [Hash] opts the optional parameters
  # @return [RateShipmentResponseBody]
  describe 'v1_rates_post test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
