...
describe 'TagsApi' do
  ...
  # unit tests for v1_tags_by_tag_name_and_new_name_put
  # tags.update_tag
  # 
  # @param tag_name 
  # @param new_name 
  ...
  # @return [nil]
  describe 'v1_tags_by_tag_name_and_new_name_put test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for v1_tags_by_tag_name_delete
  # tags.delete
  # 
  # @param tag_name 
  # @param [Hash] opts the optional parameters
  # @return [ListTagResponseBody]
  describe 'v1_tags_by_tag_name_delete test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for v1_tags_by_tag_name_post
  # tags.add_tag
  # 
  # @param tag_name 
  # @param [Hash] opts the optional parameters
  # @return [TagResponseBody]
  describe 'v1_tags_by_tag_name_post test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for v1_tags_get
  # tags.find_tags
  # 
  # @param [Hash] opts the optional parameters
  # @return [ListTagResponseBody]
  describe 'v1_tags_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
