...
describe 'CarriersApi' do
  ...
  # unit tests for v1_carriers_add_funds_by_carrier_id_put
  # carriers.add_funds
  # 
  # @param carrier_id 
  # @param body 
  ...
  describe 'v1_carriers_add_funds_by_carrier_id_put test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for v1_carriers_by_carrier_id_get
  # carriers.get_by_id
  # 
  # @param carrier_id 
  # @param [Hash] opts the optional parameters
  # @return [Carrier]
  describe 'v1_carriers_by_carrier_id_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for v1_carriers_get
  # carriers.find
  # 
  # @param [Hash] opts the optional parameters
  # @return [CarrierListResponseBody]
  describe 'v1_carriers_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for v1_carriers_options_by_carrier_id_get
  # carriers.get_options
  # 
  # @param carrier_id 
  # @param [Hash] opts the optional parameters
  # @return [CarrierListOptionsResponseBody]
  describe 'v1_carriers_options_by_carrier_id_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for v1_carriers_packages_by_carrier_id_get
  # carriers.find_packages
  # 
  # @param carrier_id 
  # @param [Hash] opts the optional parameters
  # @return [PackageListResponseBody]
  describe 'v1_carriers_packages_by_carrier_id_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for v1_carriers_services_by_carrier_id_get
  # carriers.find_services
  # 
  # @param carrier_id 
  # @param [Hash] opts the optional parameters
  # @return [CarrierListServicesResponseBody]
  describe 'v1_carriers_services_by_carrier_id_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
