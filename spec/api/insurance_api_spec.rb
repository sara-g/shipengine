...
describe 'InsuranceApi' do
  ...
  # unit tests for v1_insurance_shipsurance_add_funds_patch
  # insurance.add_funds
  # 
  # @param body 
  # @param [Hash] opts the optional parameters
  # @return [Money]
  describe 'v1_insurance_shipsurance_add_funds_patch test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for v1_insurance_shipsurance_balance_get
  # insurance.get_balance
  # 
  # @param [Hash] opts the optional parameters
  # @return [Money]
  describe 'v1_insurance_shipsurance_balance_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
