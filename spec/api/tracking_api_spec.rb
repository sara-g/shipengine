...
describe 'TrackingApi' do
  ...
  # unit tests for v1_tracking_get
  # tracking.track
  # 
  ...
  describe 'v1_tracking_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for v1_tracking_start_post
  ...
  # @option opts [String] :tracking_number 
  # @return [nil]
  describe 'v1_tracking_start_post test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for v1_tracking_stop_post
  ...
  # @option opts [String] :tracking_number 
  # @return [nil]
  describe 'v1_tracking_stop_post test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
