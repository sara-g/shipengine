...
describe 'PackagesApi' do
  ...
  # unit tests for v1_packages_by_package_id_delete
  # packages.delete
  # 
  # @param package_id 
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'v1_packages_by_package_id_delete test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for v1_packages_by_package_id_get
  # packages.get_by_id
  # 
  # @param package_id 
  # @param [Hash] opts the optional parameters
  # @return [Package]
  describe 'v1_packages_by_package_id_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for v1_packages_by_package_id_put
  # packages.update
  # 
  # @param package_id 
  # @param body 
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'v1_packages_by_package_id_put test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for v1_packages_get
  # packages.find
  # 
  # @param [Hash] opts the optional parameters
  # @return [PackageListResponseBody]
  describe 'v1_packages_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for v1_packages_post
  # packages.create
  # 
  # @param body 
  # @param [Hash] opts the optional parameters
  # @return [Package]
  describe 'v1_packages_post test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
