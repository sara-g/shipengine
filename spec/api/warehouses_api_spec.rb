...
describe 'WarehousesApi' do
  ...
  # unit tests for v1_warehouses_by_warehouse_id_delete
  # warehouses.delete
  # 
  # @param warehouse_id 
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'v1_warehouses_by_warehouse_id_delete test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for v1_warehouses_by_warehouse_id_get
  # warehouses.get_by_id
  # 
  # @param warehouse_id 
  # @param [Hash] opts the optional parameters
  # @return [Warehouse]
  describe 'v1_warehouses_by_warehouse_id_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for v1_warehouses_by_warehouse_id_put
  # warehouses.update
  # 
  # @param warehouse_id 
  # @param body 
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'v1_warehouses_by_warehouse_id_put test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for v1_warehouses_get
  # warehouses.find
  # 
  # @param [Hash] opts the optional parameters
  # @return [WarehouseListResponseBody]
  describe 'v1_warehouses_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for v1_warehouses_post
  # warehouses.create
  # 
  # @param body 
  # @param [Hash] opts the optional parameters
  # @return [Warehouse]
  describe 'v1_warehouses_post test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
