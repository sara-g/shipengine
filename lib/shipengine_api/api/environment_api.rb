...
module ShipEngineApi
  class EnvironmentApi
    ...
    # 
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<WebhookResponseBody>, Fixnum, Hash)>] Array<WebhookResponseBody> data, response status code and response headers
    def v1_environment_webhooks_get_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'Array<WebhookResponseBody>')
      if @api_client.config.debugging
