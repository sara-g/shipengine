...
module ShipEngineApi
  class PurchaseLabelRequestBody
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'test_label')
    ...
    def hash
      [shipment, is_return_label, rma_number, test_label, validate_address, label_layout, label_format].hash
    end
