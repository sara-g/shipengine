...
module ShipEngineApi
  class StampsAccountUrlsRequestBody
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'url_types')
        if (value = attributes[:'url_types']).is_a?(Array)
          self.url_types = value
        end
      end
    end
