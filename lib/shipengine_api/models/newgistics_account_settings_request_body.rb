...
module ShipEngineApi
  class NewgisticsAccountSettingsRequestBody
    attr_accessor :include_barcode_with_order_number

    attr_accessor :receive_email_on_manifest_processing
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'include_barcode_with_order_number')
        self.include_barcode_with_order_number = attributes[:'include_barcode_with_order_number']
      end

      if attributes.has_key?(:'receive_email_on_manifest_processing')
        self.receive_email_on_manifest_processing = attributes[:'receive_email_on_manifest_processing']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          include_barcode_with_order_number == o.include_barcode_with_order_number &&
          receive_email_on_manifest_processing == o.receive_email_on_manifest_processing
    end
    ...
    def hash
      [include_barcode_with_order_number, receive_email_on_manifest_processing].hash
    end
