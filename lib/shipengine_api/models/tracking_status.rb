...
module ShipEngineApi
  class TrackingStatus
    ...
    def build_from_hash(value)
      constantValues = TrackingStatus.constants.select { |c| TrackingStatus::const_get(c) == value }
      raise "Invalid ENUM value #{value} for class #TrackingStatus" if constantValues.empty?
      value
    end
  end
end
