...
module ShipEngineApi
  class RateResponseStatus
    ...
    def build_from_hash(value)
      constantValues = RateResponseStatus.constants.select { |c| RateResponseStatus::const_get(c) == value }
      raise "Invalid ENUM value #{value} for class #RateResponseStatus" if constantValues.empty?
      value
    end
  end
end
