...
module ShipEngineApi
  class Package
    # A string that uniquely identifies the package id
    ...
    def list_invalid_properties
      ...
      if !@package_id.nil? && @package_id.to_s.length > 25
        invalid_properties.push('invalid value for "package_id", the character length must be smaller than or equal to 25.')
      end
      ...
      if !@package_id.nil? && @package_id !~ Regexp.new(/^se(-[a-z0-9]+)+$/)
        invalid_properties.push('invalid value for "package_id", must conform to the pattern /^se(-[a-z0-9]+)+$/.')
      end
    ...
    def valid?
      return false if !@package_id.nil? && @package_id.to_s.length > 25
      return false if !@package_id.nil? && @package_id.to_s.length < 1
      return false if !@package_id.nil? && @package_id !~ Regexp.new(/^se(-[a-z0-9]+)+$/)
    ...
    def package_id=(package_id)
      if !package_id.nil? && package_id.to_s.length > 25
        fail ArgumentError, 'invalid value for "package_id", the character length must be smaller than or equal to 25.'
      end
      ...
      if !package_id.nil? && package_id !~ Regexp.new(/^se(-[a-z0-9]+)+$/)
        fail ArgumentError, 'invalid value for "package_id", must conform to the pattern /^se(-[a-z0-9]+)+$/.'
      end
    ...
    def hash
      [package_id, package_code, name, dimensions, description].hash
    end
