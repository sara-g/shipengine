...
module ShipEngineApi
  ...
  class Prev
    ...
    def list_invalid_properties
      ...
      if !@href.nil? && @href.to_s.length < 1
    ...
    def valid?
      return false if !@href.nil? && @href.to_s.length < 1
      true
    end
