...
module ShipEngineApi
  class TrackingInformationResponseBody
    ...
    attr_accessor :carrier_status_code

    attr_accessor :carrier_status_description
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'carrier_status_code')
        self.carrier_status_code = attributes[:'carrier_status_code']
      end

      if attributes.has_key?(:'carrier_status_description')
      ...
      if attributes.has_key?(:'exception_description')
