...
module ShipEngineApi
  class NonDelivery
    ...
    TREAT_AS_ABANDONED = 'treat_as_abandoned'.freeze

    # Builds the enum from string
    # @param [String] The enum value in the form of the string
    # @return [String] The enum value
    def build_from_hash(value)
      constantValues = NonDelivery.constants.select { |c| NonDelivery::const_get(c) == value }
      raise "Invalid ENUM value #{value} for class #NonDelivery" if constantValues.empty?
      value
    end
  end
end
