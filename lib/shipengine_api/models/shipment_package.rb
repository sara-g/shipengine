...
module ShipEngineApi
  class ShipmentPackage
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'insured_value')
        self.insured_value = attributes[:'insured_value']
      end

      if attributes.has_key?(:'label_messages')
        self.label_messages = attributes[:'label_messages']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          label_messages == o.label_messages
    end
    ...
    def hash
      [package_code, weight, dimensions, insured_value, label_messages].hash
    end
