...
module ShipEngineApi
  class RateShipmentRequestBody
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'shipment')
        self.shipment = attributes[:'shipment']
      end

      if attributes.has_key?(:'rate_options')
        self.rate_options = attributes[:'rate_options']
      end
    end
    ...
    def hash
      [shipment_id, shipment, rate_options].hash
    end
