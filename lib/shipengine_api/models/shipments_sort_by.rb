...
module ShipEngineApi
  class ShipmentsSortBy
    ...
    def build_from_hash(value)
      constantValues = ShipmentsSortBy.constants.select { |c| ShipmentsSortBy::const_get(c) == value }
      raise "Invalid ENUM value #{value} for class #ShipmentsSortBy" if constantValues.empty?
      value
    end
  end
end
