...
module ShipEngineApi
  class UrlType
    ...
    ACCOUNT_SETTINGS = 'account_settings'.freeze
    REPORT_BALANCES = 'report_balances'.freeze
    MANIFEST_FORM = 'manifest_form'.freeze
    ...
    def build_from_hash(value)
      constantValues = UrlType.constants.select { |c| UrlType::const_get(c) == value }
      raise "Invalid ENUM value #{value} for class #UrlType" if constantValues.empty?
      value
    end
  end
end
