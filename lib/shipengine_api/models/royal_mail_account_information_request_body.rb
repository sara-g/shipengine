...
module ShipEngineApi
  class RoyalMailAccountInformationRequestBody
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'oba_email')
      ...
      if attributes.has_key?(:'street_line3')
    ...
    def list_invalid_properties
      ...
      if !@oba_email.nil? && @oba_email.to_s.length < 1
        invalid_properties.push('invalid value for "oba_email", the character length must be great than or equal to 1.')
      end
    ...
    def valid?
      return false if !@oba_email.nil? && @oba_email.to_s.length < 1
      return false if !@email.nil? && @email.to_s.length < 1
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] oba_email Value to be assigned
    def oba_email=(oba_email)
      if !oba_email.nil? && oba_email.to_s.length < 1
        fail ArgumentError, 'invalid value for "oba_email", the character length must be great than or equal to 1.'
      end
