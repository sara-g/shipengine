...
module ShipEngineApi
  class MailInnovationsEndorsement
    ...
    LEAVE_IF_NO_RESPONSE = 'leave_if_no_response'.freeze

    # Builds the enum from string
    # @param [String] The enum value in the form of the string
    # @return [String] The enum value
    def build_from_hash(value)
      constantValues = MailInnovationsEndorsement.constants.select { |c| MailInnovationsEndorsement::const_get(c) == value }
      raise "Invalid ENUM value #{value} for class #MailInnovationsEndorsement" if constantValues.empty?
      value
    end
  end
end
