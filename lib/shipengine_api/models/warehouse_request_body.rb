...
module ShipEngineApi
  class WarehouseRequestBody
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'origin_address')
        self.origin_address = attributes[:'origin_address']
      end

      if attributes.has_key?(:'return_address')
    ...
    def hash
      [warehouse_id, name, origin_address, return_address].hash
    end
