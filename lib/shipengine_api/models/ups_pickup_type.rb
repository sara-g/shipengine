...
module ShipEngineApi
  class UpsPickupType
    ...
    DAILY_PICKUP = 'daily_pickup'.freeze
    OCCASIONAL_PICKUP = 'occasional_pickup'.freeze
    CUSTOMER_COUNTER = 'customer_counter'.freeze

    # Builds the enum from string
    # @param [String] The enum value in the form of the string
    # @return [String] The enum value
    def build_from_hash(value)
      constantValues = UpsPickupType.constants.select { |c| UpsPickupType::const_get(c) == value }
      raise "Invalid ENUM value #{value} for class #UpsPickupType" if constantValues.empty?
      value
    end
  end
end
