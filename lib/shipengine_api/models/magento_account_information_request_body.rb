...
module ShipEngineApi
  class MagentoAccountInformationRequestBody
    ...
    def self.swagger_types
      {
        ...
        :'username' => :'String',
        :'password' => :'String',
        :'settings' => :'MagentoAccountSettingsRequestBody'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'store_url')
    ...
    def hash
      [store_name, store_url, username, password, settings].hash
    end
